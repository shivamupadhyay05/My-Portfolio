  ...
  return (
    <div className="bento-card about-card" id="about">
      <div className="about-header">
        <img src={myPhoto} alt="Shivam Upadhyay" className="about-avatar" />
        <div className="about-title-group">
          <h1>Shivam Upadhyay</h1>
          <h2>B.Tech CSE @ Bennett University (2027)</h2>
          <h3>Specialization(Cloud Computing)</h3>
        </div>
      </div>
      ...
      <div className="about-socials">
        <a
          href="https://github.com/shivamupadhyay05"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/shivam-upadhyay-34666b277/"
          target="_blank"
          rel="noopener noreferrer"
          className="social-btn"
          aria-label="LinkedIn"
        ...
        <a
          href="mailto:Shivamu0504@gmail.com"
          className="social-btn"
          aria-label="Email"
        >
          <i className="fas fa-envelope"></i>
        </a>
        <a href="tel:+916390533255" className="social-btn" aria-label="Phone">
